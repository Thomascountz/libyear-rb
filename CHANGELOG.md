...
- Extract `Config` object for programmatic configuration
- Add `LibyearRb.analyze` public API method accepting lockfile contents and config
- Replace `SKIP_CACHE` env var with `--skip-cache` CLI flag
